...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Swayblade's Point of Sale")
        ...
        self.stacked_widget.addWidget(self.new_order)

        self.home.btn1.clicked.connect(lambda: self.stacked_widget.setCurrentIndex(0))
    ...
    #
    # def new_order(self):
    #     new_order_widget = OrderWindowWidget(self)
    #     self.central_widget.addWidget(new_order_widget)
    #     self.setCentralWidget(new_order_widget)
    #
    # def customer_entry(self):
    #     customer_entry_widget = CustomerEntryWidget(self)
    #     self.central_widget.addWidget(customer_entry_widget)
    #     self.setCentralWidget(customer_entry_widget)
...
class HomeWidget(QWidget):
    def __init__(self, parent=MainWindow):
        ...
        layout = QHBoxLayout()
        self.btn1 = QPushButton('New Order', OrderWindowWidget)
        self.btn2 = QPushButton('Customer Entry')
